...
class DataOwners:
    def __init__(self):
        self.data_path = '../datasets/winequality-red.csv'

    def get_total_data(self, data_path):
        data = pd.read_csv(data_path, sep=';')
        return data

    def simulate_multiusers(self, data, userNum=2):
    ...
    def normalize_global(self, X, g_max, g_min):
        """
    ...
    def encrypt_data(self, M, pk):
        """
        将本地数据加密
        :param M: 逐个拓展后的数据矩阵
        :param pk: public key 公钥
